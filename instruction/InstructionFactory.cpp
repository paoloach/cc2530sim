...
InstructionFactory::InstructionFactory(InstructionPointer &IP, FlashMemory &flashMemory, XData &xdata) : IP(
    ...
    decodeMap[0x02] = std::make_shared<InstrTemp4<Instructions::LJMP>>(*this, IP, flashMemory,xdata);
    ...
    decodeMap[0x12] = std::make_shared<InstrTemp6<Instructions::LCALL>>(*this, IP, flashMemory,xdata);
    ...
    decodeMap[0x73] = std::make_shared<InstrTemp2<Instructions::JMP_A_DPTR>>(*this, IP, flashMemory,xdata);
    decodeMap[0x74] = std::make_shared<InstrTemp2<Instructions::MOV_A_DATA>>(*this, IP, flashMemory,xdata);
    ...
    decodeMap[0x80] = std::make_shared<InstrTemp3<Instructions::SJMP>>(*this, IP, flashMemory,xdata);
    ...
    decodeMap[0x90] = std::make_shared<InstrTemp3<Instructions::MOV_DPTR_DATA>>(*this, IP, flashMemory,xdata);
    ...
    decodeMap[0xE0] = std::make_shared<InstrTemp3<Instructions::MOVX_A_AT_DPTR>>(*this, IP, flashMemory,xdata);
    decodeMap[0xE1] = std::make_shared<InstrTemp3<Instructions::AJMP>>(*this, IP, flashMemory,xdata);
    decodeMap[0xE2] = std::make_shared<InstrTemp3<Instructions::MOVX_A_AT_R>>(*this, IP, flashMemory,xdata);
    decodeMap[0xE3] = std::make_shared<InstrTemp3<Instructions::MOVX_A_AT_R>>(*this, IP, flashMemory,xdata);
    decodeMap[0xE4] = std::make_shared<InstrTemp1<Instructions::CLR_A>>(*this, IP, flashMemory,xdata);
    ...
    decodeMap[0xF4] = std::make_shared<InstrTemp1<Instructions::CPL_A>>(*this, IP, flashMemory,xdata);
